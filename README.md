...
| [menu_navigation](docs/api/examples.md#menu_navigation) | Several screens, a fade between them, and settings that persist |
...
| [cutscene](docs/api/examples.md#cutscene) | A scene everybody watches, and a held skip that ends it the same way |
...
- a better scene manager that means less boilerplate in each game with scene transitions. With it an example for teleports/room-transitions - **DONE**
...
- an example (and if needed, new components) for inventory and equipment screens - **DONE**
- an example (and if needed, new components) for collectable and interactable nodes like coins and treasure chests - **DONE**
- audio transitions - fades, pauses, etc. - **DONE**
- visual effects like lightning, sparkles, fade-to-black - **DONE**
- better engine support for cutscenes - **DONE**
