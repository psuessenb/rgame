...
# `Engine::TileMap` (see stub_tile_map_spec.rb).
#
...
# `Engine::Tileset` parses out of a `.tsx`, spelled as plain Arrays so a spec
...
class StubTileset
  ...
  # The frame showing at `ms`, cycling. Mirrors Engine::Tileset's own
