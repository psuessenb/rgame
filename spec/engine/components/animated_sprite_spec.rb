...
RSpec.describe Engine::Components::AnimatedSprite do
  ...
  let(:node) { Engine::Node2D.new(x: 5.0, y: 7.0) }
  let(:body) { Engine::Components::CharacterBody.new(feet_width: 8, feet_height: 6, speed: 50.0) }
