...
RSpec.describe Engine::Components::WanderController do
  let(:body) { Engine::Components::CharacterBody.new(feet_width: 8, feet_height: 8, speed: 60.0) }
  ...
  describe '#update' do
    ...
    it 'is deterministic for a given seed' do
      ...
      body_b = Engine::Components::CharacterBody.new(feet_width: 8, feet_height: 8, speed: 60.0)
      nb = Engine::Node2D.new
