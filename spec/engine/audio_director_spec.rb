...
RSpec.describe Engine::AudioDirector do
  ...
  describe 'subscribe' do
    it 'registers as the handler for the audio events' do
      ...
      Engine::AudioBus.on_play_music.emit(:heartbeat)
      Engine::AudioBus.on_play_sound.emit(:shoot)
      Engine::AudioBus.on_stop_music.emit
