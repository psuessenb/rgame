...
class Crate < RGame::Engine::Node2D
  ...
  def initialize(**)
    ...
    add_component(RGame::Engine::Components::Pushable.new(blocked_by: %i[tiles crate hero]))
    add_component(RGame::Engine::Components::Footing.new(coyote: 0))
    add_component(RGame::Engine::Components::Respawn.new(flash: 0.5))
  end
