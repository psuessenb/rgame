...
module Asteroids
  ...
  class GameOverScene < Engine::Node2D
    ...
    TITLE_COLOR = Util::Color.new(255, 200, 200)
    TEXT_COLOR  = Util::Color.new(220, 225, 235)
    HINT_COLOR  = Util::Color.new(150, 170, 200)
    ...
    def _control(actions)
      ...
      system!(Engine::AudioOut).play_sound(:blip)
      root.go(:play)
    end
