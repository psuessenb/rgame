...
module Adventure
  ...
  class Bag < Engine::Node2D
    ...
    def initialize(hero:, **)
      ...
      @carried = page_menu
      @worn = page_menu
      @tabs.add(UI::TextButton.new(label: Engine::Text.literal('Carried')), @carried.parent)
      @tabs.add(UI::TextButton.new(label: Engine::Text.literal('Worn')), @worn.parent)
    ...
    def list(items)
      ...
      button = @carried.add(UI::TextButton.new(label: Engine::Text.literal(label)))
    ...
    def show(slot)
      ...
      @worn.add(UI::TextButton.new(label: Engine::Text.literal(label))).on_activated do
